...
<input type=button value='Tambah Sub Utama' onclick=location.href='?module=submenu&act=tambahsubmenu' class='btn btn-success pull-right'><br/>
          ...
          <thead><tr><th>No</th><th>Sub Menu</th><th>Menu Utama</th><th>Link Submenu</th><th>Aktif</th><th>Admin Menu</th></tr></thead>";

    $tampil = mysql_query("SELECT nama_sub,nama_menu,link_sub,adminsubmenu,submenu.aktif,id_sub FROM submenu,mainmenu WHERE submenu.id_main=mainmenu.id_main");
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr><td>$no</td>
				...
				<td align=center>$r[adminsubmenu]</td>
				<td>
  ...
  case "editsubmenu":
    ...
    $r    = mysql_fetch_array($edit);
	    ...
	    echo "
		  ...
		  <i class='icon-list-alt icon-white'></i> Edit Sub Menu</div></li>
		  </ul>
		  </div>
		  </div>
		  </div>
