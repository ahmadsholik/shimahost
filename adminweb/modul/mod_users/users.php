...
<li><div style='color:white; padding-top:9px; text-align:left;'><i class='icon-user icon-white'></i> User</div></li>
    ...
    echo "<table class='table table-condensed' width=100%>
          <thead><tr><th>no</th><th>username</th><th>nama lengkap</th><th>email</th><th>No.Telp/HP</th><th>Level</th><th>Blokir</th><th></th></tr></thead>"; 
    $no=1;
...
<li><div style='color:white; padding-top:9px; text-align:left;'><i class='icon-user icon-white'></i> Tambah User</div></li>
	      ...
	      <label>Level</label>
		  <input type=radio name='level' value='admin' class='span2'> Admin
		  <input type=radio name='level' value='user'  class='span2' checked> User
		  <label></label>
...
<li><div style='color:white; padding-top:9px; text-align:left;'><i class='icon-user icon-white'></i> Edit User</div></li>
	...
	if ($r[level]=='user'){
      echo "<label>Level</label>
            ...
            <input type=radio name='level' value='user' checked> User <p></p>";
    }
    else{
      echo "<label>Level</label>
	  		<td><input type=radio name='level' value='admin' checked> Admin  
            <input type=radio name='level' value='user'> User <p></p>";
    }
