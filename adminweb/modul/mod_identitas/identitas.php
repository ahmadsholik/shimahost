...
<li><div style='color:white; padding-top:9px; text-align:left;'><i class='icon-globe icon-white'></i> Profil Web</div></li>
		  ...
		  <input type=text name='nama_website' value='$r[nama_toko]' class='span12'>
		  <label>E-mail Pengelola</label>
		  <input type=text name='alamat_website' value='$r[email_pengelola]' class='span12'>
		  ...
		  <textarea name='isi' style='width: 600px; height: 250px;'>$r[static_content]</textarea></td></tr>
		  </div>
