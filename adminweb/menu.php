...
<a class='brand' href=?module=home >Administrator Panel</a>
<div class='nav-collapse collapse'>
	<ul class='nav'>
	<li class='dropdown'><a href=?module=home class='dropdown-toggle' data-toggle='dropdown'><i class='icon-home icon-white'></i> Home</a>
		<ul class='dropdown-menu'>
			<li><a href=?module=berita><i class='icon-pencil icon'></i> Artikel</a></li>
	...
	<li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown'><i class='icon-th icon-white'></i> Media</a>
		<ul class='dropdown-menu'>
			<li><a href=?module=download><i class='icon-folder-open icon'></i> File Download</a></li>
...
<div class='btn-group dropdown pull-right'>
  <button class='btn btn-primary'><i class='icon-user icon-white'></i> $_SESSION[namauser]</button>
...
<a class='brand' href=?module=home >Lokomedia</a>
<div class='nav-collapse collapse'>
	<ul class='nav'>

			<li><a href=?module=berita><i class='icon-pencil icon-white'></i> Berita</a></li>
			<li><a href=?module=agenda><i class='icon-calendar icon-white'></i> Agenda</a></li>
